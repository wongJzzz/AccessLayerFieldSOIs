...
@ServerObjectExtProperties(
        displayName = "AccessLayerFieldSOIs",
        description = "Layers and Fields Accessible controller",
        interceptor = true,
        servicetype =  "MapService" ,
         properties = "" ,
		supportsSharedInstances = false)

public class AccessLayerFieldSOIs
	 ...
	 * @throws Exception
	 */
	public AccessLayerFieldSOIs() throws Exception {
		super();
	...
	public byte[] handleRESTRequest(String capabilities, String resourceName, String operationName,
		 ...
		 */
		serverLog.addMessage(3, 200, "Request logged in AccessLayerFieldSOIs. User: " + getLoggedInUserName() + ", Operation: "
...
//		this.mapService = (IMapServer) this.soHelper.getServerObject();
		...
		if (restRequestHandler != null) {
			...
			if(operationName!=null && operationName.equals("export")){
				if(operationParametersJson.has("accesslayer")){
					String layerNameListString = operationParametersJson.getString("accesslayer");
					String layerIdListString = "show:"+this.soiUtil.getLayerIdStringByNameListString(this.mapService, layerNameListString);
					operationParametersJson.put("layers",layerIdListString);
					String modifiedOperationInput = operationParametersJson.toString();
			...
			if(operationName!=null && operationName.equals("query")){
				if(operationParametersJson.has("accessfield")){
					String fieldNameListString = operationParametersJson.getString("accessfield");
					operationParametersJson.put("outFields",fieldNameListString);
					String modifiedOperationInput = operationParametersJson.toString();
					return restRequestHandler.handleRESTRequest(
							capabilities, resourceName, operationName, modifiedOperationInput,
							outputFormat, requestProperties, responseProperties);
	...
	public String handleStringRequest(String capabilities, String request) throws IOException, AutomationException {
		// Log message with server
		serverLog.addMessage(3, 200, "Request received in AccessLayerFieldSOIs Interceptor for handleStringRequest");
	...
	public byte[] handleStringWebRequest(int httpMethod, String requestURL, String queryString, String capabilities,
			...
			throws IOException, AutomationException {
		serverLog.addMessage(3, 200, "Request received in AccessLayerFieldSOIs Interceptor for handleStringWebRequest");
	...
	public byte[] handleBinaryRequest2(String capabilities, byte[] request) throws IOException, AutomationException {
		serverLog.addMessage(3, 200, "Request received in AccessLayerFieldSOIs Interceptor for handleBinaryRequest2");
	...
	public String getSchema() throws IOException, AutomationException {
		serverLog.addMessage(3, 200, "Request received in AccessLayerFieldSOIs Interceptor for getSchema");
	...
	public byte[] handleBinaryRequest(byte[] request) throws IOException, AutomationException {
		serverLog.addMessage(3, 200, "Request received in AccessLayerFieldSOIs Interceptor for handleBinaryRequest");
